...
optionsB = pygame.transform.scale(pygame.image.load(address+"\snake_assets\img\optionsB.png"), (100,40))
PenaltyB = pygame.transform.scale(pygame.image.load(address+"\snake_assets\img\PenaltyB.png"), (100,40))
backB = pygame.transform.scale(pygame.image.load(address+"\snake_assets\img\BackB.png"), (100,40))
...
mode1 = pygame.transform.scale(pygame.image.load(address+"\snake_assets\img\mode1.png"), (100,40))
mode2 = pygame.transform.scale(pygame.image.load(address+"\snake_assets\img\mode2.png"), (100,40))
...
def mainmenu():
    while True:
        ...
        main_window.blit(GameTitle, (100,50))
